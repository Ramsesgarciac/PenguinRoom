...
@Component({
  selector: 'app-cuartos2000to2500',
  templateUrl: './cuartos2000to2500.page.html',
  styleUrls: ['./cuartos2000to2500.page.scss'],
})
export class Cuartos2000to2500Page implements OnInit {
  ...
  ngOnInit() {
    this.rentaS.getRentas2000to2500().subscribe((rentass) => {
